 ...
 */
function g(t){return function(t){if(Array.isArray(t))return T(t)}(t)||function(t){if("undefined"!=typeof Symbol&&null!=t[Symbol.iterator]||null!=t["@@iterator"])return Array.from(t)}(t)||function(t,e){if(!t)return;if("string"==typeof t)return T(t,e);var o=Object.prototype.toString.call(t).slice(8,-1);"Object"===o&&t.constructor&&(o=t.constructor.name);if("Map"===o||"Set"===o)return Array.from(t);if("Arguments"===o||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o))return T(t,e)}(t)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function T(t,e){(null==e||e>t.length)&&(e=t.length);for(var o=0,i=new Array(e);o<e;o++)i[o]=t[o];return i}var E=function t(e){n.FieldDropdown.call(this,t.dropdownCreate,t.dropdownChange),e?this.doValueUpdate_(e):this.doValueUpdate_(n.Variables.generateUniqueName())};n.utils.object.inherits(E,n.FieldDropdown),E.prototype.setValue=function(t){if(t&&" "!==t){var e=t.split(" ");2==e.length&&"global"!==e[0]&&(t="global "+e[1])}E.superClass_.setValue.call(this,t)},E.prototype.doClassValidation_=function(t){return t},E.prototype.getBlock=function(){return this.block_},E.prototype.setBlock=function(t){this.block_=t},E.getGlobalNames=function(t){if(n.getMainWorkspace()&&n.getMainWorkspace().getWarningHandler&&n.getMainWorkspace().getWarningHandler().cacheGlobalNames)return n.getMainWorkspace().getWarningHandler().cachedGlobalNames;var e=[];if(n.mainWorkspace){var o=[];o=n.mainWorkspace.getTopBlocks();for(var i=0;i<o.length;i++){var s=o[i];s.getGlobalNames&&s!=t&&e.push.apply(e,g(s.getGlobalNames()))}}return e},E.prototype.getNamesInScope=function(){return E.getNamesInScope(this.block_)},E.getNamesInScope=function(t){var e=E.getGlobalNames();e=(e=f.sortAndRemoveDuplicates(e)).map((function(t){return[_(t),"global "+t]}));var o=E.getLexicalNamesInScope(t);return e.concat(o)},E.getLexicalNamesInScope=function(t){var e,o,i=[],n={};function s(t,e,o){var i;n[t]||(n[t]=o),i=(n[t],function(t){return""+t})(t),e.push(i)}if((o=t)&&(e=o.getParent()))for(;e;)e.withLexicalVarsAndPrefix&&e.withLexicalVarsAndPrefix(o,(function(t,e){s(t,i,e)})),o=e,e=e.getParent();return(i=f.sortAndRemoveDuplicates(i)).map((function(t){return[t,t]}))},E.dropdownCreate=function(){var t=this.getNamesInScope();return 0==t.length?[[" "," "]]:t},E.prototype.doValueUpdate_=function(t){n.FieldDropdown.superClass_.doValueUpdate_.call(this,t);for(var e,o=this.getOptions(!0,[[t,t]]),i=0;e=o[i];i++)e[1]==this.value_&&(this.selectedOption_=e);this.forceRerender()},E.prototype.getOptions=function(t,e){Array.isArray(t)&&(e=t);var o=e||[];return this.isOptionListDynamic()?(this.generatedOptions_&&t||(this.generatedOptions_=this.menuGenerator_.call(this).concat(o),n.FieldDropdown.validateOptions_(this.generatedOptions_)),this.generatedOptions_.concat(o)):this.menuGenerator_},E.dropdownChange=function(t){if(t){this.doValueUpdate_(t);var e=this.sourceBlock_.workspace.getTopWorkspace();e.getWarningHandler&&e.getWarningHandler().checkErrors(this.sourceBlock_)}},E.nameNotIn=function(t,e){for(var o=E.prefixSuffix(t),i=o[0],n=o[1],s=!1,r=!1,a=[],l=0;l<e.length;l++){var c=E.prefixSuffix(e[l]),u=c[0],h=c[1];u===i&&(h===n&&(r=!0),""===h?s=!0:a.push(h))}if(r){if(s){var p=a.map((function(t,e,o){return parseInt(t,10)}));p.sort((function(t,e){return t-e}));for(var _=2,d=0;d<p.length;){if(_<p[d])return i+_;_==p[d]?(_++,d++):d++}return i+_}return i}return t},E.prefixSuffix=function(t){var e=t.match(/^(.*?)(\d+)$/);return e?[e[1],e[2]]:[t,""]},E.fromJson=function(t){var e=n.utils.replaceMessageReferences(t.name);return new E(e)},n.fieldRegistry.register("field_lexical_variable",E);var f={renameGlobal:function(t){var e=this.value_;t=f.makeLegalIdentifier(t),this.sourceBlock_.getField("NAME").doValueUpdate_(t);var o=E.getGlobalNames(this.sourceBlock_);if(t=E.nameNotIn(t,o),this.sourceBlock_.rendered&&n.mainWorkspace)for(var i=n.mainWorkspace.getAllBlocks(),s=0;s<i.length;s++){var r=i[s],a=r.renameLexicalVar;a&&a.call(r,"global "+e,"global "+t,n.Msg.LANG_VARIABLES_GLOBAL_PREFIX+" "+e,n.Msg.LANG_VARIABLES_GLOBAL_PREFIX+" "+t)}return t},renameParam:function(t){var e=this.htmlInput_,o=this.getValue()||e&&e.defaultValue||this.getText();return t=f.makeLegalIdentifier(t),f.renameParamFromTo(this.sourceBlock_,o,t,!1)},renameParamFromTo:function(t,e,o,i){return t.mustNotRenameCapturables?f.renameParamWithoutRenamingCapturables(t,e,o,[]):i?(f.renameParamRenamingCapturables(t,e,o),o):f.renameParamWithoutRenamingCapturables(t,e,o,[])},renameParamRenamingCapturables:function(t,e,o){if(o!==e){var i=t.declaredNames?t.declaredNames():[];if(-1==i.indexOf(e))throw Error("LexicalVariable.renamingCapturables: oldName "+e+" is not in declarations {"+i.join(",")+"}");var s=[];E.getNamesInScope(t).map((function(t){t[0]==t[1]?s.push(t[0]):s.push(t[0],t[1])}));var r=i.concat(s);if(-1!=r.indexOf(o))throw Error("LexicalVariable.renameParamRenamingCapturables: newName "+o+" is in existing declarations {"+r.join(",")+"}");if(!t.renameBound)throw Error("LexicalVariable.renameParamRenamingCapturables: block "+t.type+" is not a declaration block.");var a=n.Substitution.simpleSubstitution(e,o),l=new n.Substitution;t.renameBound(a,l)}},renameFree:function(t,e){t&&(t.renameFree?t.renameFree(e):t.getChildren().map((function(t){f.renameFree(t,e)})))},freeVariables:function(t){var e=[];if(t)if(t.freeVariables)e=t.freeVariables();else{var o=t.getChildren().map((function(t){return f.freeVariables(t)}));e=n.NameSet.unionAll(o)}else e=new n.NameSet;return e},renameParamWithoutRenamingCapturables:function(t,e,o,i){if(e===o)return e;!t.declaredNames||t.declaredNames();var n="";var s=f.renameParamWithoutRenamingCapturablesInfo(t,e,n),r=s[0],a=s[1],l=[];if(t.declaredNames){var c=(l=t.declaredNames()).indexOf(e);if(-1!=c&&l.splice(c,1),-1!=i.indexOf(o)){var u=l.indexOf(o);-1!=u&&l.splice(u,1)}}var h,p=f.sortAndRemoveDuplicates(a.concat(l));if((o=E.nameNotIn(o,p))!==e&&!(-1!=l.indexOf(e)))for(var _=0;_<r.length;_++){var d=r[_],g=d.renameLexicalVar;g&&g.call(d,""+(h=e),function(t){return""+t}(o))}return o},renameParamWithoutRenamingCapturablesInfo:function(t,e,o){var i=[];t.blocksInScope&&(i=t.blocksInScope());for(var n=i.map((function(t){return f.referenceResult(t,e,o,[])})),s=[],r=[],a=0;a<n.length;a++)s=s.concat(n[a][0]),r=r.concat(n[a][1]);return[s,r=f.sortAndRemoveDuplicates(r)]},checkIdentifier:function(t){var e=t.trim().replace(/[\s\xa0]+/g,"_"),o=new RegExp("^[^-0-9!&%^/>=<`'\"#:;,\\\\*+.()|{}[\\] ][^-!&%^/>=<'\"#:;,\\\\*+.()|{}[\\] ]*$");return{isLegal:0==e.search(o),transformed:e}},makeLegalIdentifier:function(t){var e=f.checkIdentifier(t);return e.isLegal?e.transformed:""===e.transformed?"_":"name"},referenceResult:function(t,e,o,i){if(!t)return[[],[]];for(var n=t.referenceResults?t.referenceResults(e,o,i):t.getChildren().map((function(t){return f.referenceResult(t,e,o,i)})),s=[],r=[],a=0;a<n.length;a++)s=s.concat(n[a][0]),r=r.concat(n[a][1]);return[s,r]},sortAndRemoveDuplicates:function(t){var e=t.sort(),o=[];if(t.length>=1){var i=e[0];o.push(i);for(var n=1;n<e.length;n++)e[n]!==i&&(i=e[n],o.push(i))}return o},getNextTargetBlock:function(t){return t&&t.nextConnection&&t.nextConnection.targetBlock()?t.nextConnection.targetBlock():null},stringListsEqual:function(t,e){var o=t.length;if(o!==e.length)return!1;for(var i=0;i<o;i++)if(t[i]!==e[i])return!1;return!0}},m=["",""],v=function(t){var e=this.block.workspace.getTopWorkspace();if(this.block.isEditable()){var o=e.getProcedureDatabase().getProcedure(t);if(o){var i=o.getFieldValue("NAME");if(""==i||i!=this.getValue())for(var s=0;null!=this.block.getInput("ARG"+s);s++)this.block.removeInput("ARG"+s);this.doValueUpdate_(i),o&&this.block.setProcedureParameters(o.arguments_,o.paramIds_,!0)}}else e=n.Drawer.flyout_.workspace_},b=function(t,e){for(var o=(e||n.mainWorkspace).getTopBlocks(),i=[m],s=0;s<o.length;s++){var r=o[s].getFieldValue("NAME");"procedures_defnoreturn"!=o[s].type||t?"procedures_defreturn"==o[s].type&&t&&i.push([r,r]):i.push([r,r])}return i.length>1&&i.splice(0,1),i},y=function(t,e){if(e&&e===n.mainWorkspace)for(var o=e.getAllBlocks(),i=0;i<o.length;i++){var s=o[i];"procedures_callreturn"!=s.type&&"procedures_callnoreturn"!=s.type||s.getFieldValue("PROCNAME")==t&&s.removeProcedureValue()}},R=function(t){var e=this.oldName_||this.getValue(),o=t;t=f.makeLegalIdentifier(t);var i=function(t){for(var e=t.workspace.getTopBlocks(!1),o=[],i=0;i<e.length;i++)"procedures_defnoreturn"!==e[i].type&&"procedures_defreturn"!==e[i].type||e[i]!==t&&o.push(e[i]);return o}(this.sourceBlock_).map((function(t){return t.getFieldValue("NAME")}));(t=E.nameNotIn(t,i))!==o&&this.doValueUpdate_(t);for(var n=this.sourceBlock_.workspace.getAllBlocks(),s=0;s<n.length;s++){var r=n[s].renameProcedure;r&&r.call(n[s],e,t)}return this.oldName_=t,t},S=function(t){this.workspace_=t,this.procedures_={},this.returnProcedures_={},this.voidProcedures_={},this.length=0,this.returnProcedures=0,this.voidProcedures=0};S.defaultValue=["","none"],S.prototype.getNames=function(t){return b(t,this.workspace_).map((function(t){return t[0]}))},S.prototype.getMenuItems=function(t){return b(t,this.workspace_)},S.prototype.getDeclarationBlocks=function(t){return n.utils.object.values(t?this.returnProcedures_:this.voidProcedures_)},S.prototype.getDeclarationsBlocksExcept=function(t){var e=[];return n.utils.values(this.procedures_).forEach((function(o){o!==t&&e.push(o)})),e},S.prototype.getAllDeclarationNames=function(){return n.utils.values(this.procedures_).map((function(t){return t.getFieldValue("NAME")}))},S.prototype.addProcedure=function(t,e){if("procedures_defnoreturn"!=e.type&&"procedures_defreturn"!=e.type)return console.warn("Attempt to addProcedure with block type "+e.type),!1;var o=e.id;return!(o in this.procedures_)&&(this.procedures_[o]=e,this.length++,"procedures_defnoreturn"==e.type?(this.voidProcedures_[o]=e,this.voidProcedures++):(this.returnProcedures_[o]=e,this.returnProcedures++),!0)},S.prototype.removeProcedure=function(t){t in this.procedures_&&("procedures_defnoreturn"==this.procedures_[t].type?(delete this.voidProcedures_[t],this.voidProcedures--):(delete this.returnProcedures_[t],this.returnProcedures--),delete this.procedures_[t],this.length--);return!0},S.prototype.renameProcedure=function(t,e,o){},S.prototype.getProcedure=function(t){var e=this.procedures_[t];return e||this.getProcedureByName(t)},S.prototype.getProcedureByName=function(t){for(var e in this.procedures_)if(this.procedures_[e].getFieldValue("NAME")===t)return this.procedures_[e]},S.prototype.clear=function(){this.procedures_={},this.returnProcedures_={},this.voidProcedures_={},this.length=0,this.returnProcedures=0,this.voidProcedures=0},n.WorkspaceSvg.prototype.flydown_=null,n.WorkspaceSvg.prototype.getFlydown=function(){return this.flydown_},n.WorkspaceSvg.prototype.getProcedureDatabase=function(){return this.procedureDb_||(this.procedureDb_=new S(this)),this.procedureDb_},n.WorkspaceSvg.prototype.getTopWorkspace=function(){for(var t=this;t.targetWorkspace;)t=t.targetWorkspace;return t},n.WorkspaceSvg.prototype.getWarningHandler=function(){return i};
/**
 * @license
 ...
 */
var C=function t(e,o,i,n){this.EDITABLE=o,this.displayLocation=i||t.DISPLAY_RIGHT,t.superClass_.constructor.call(this,e,n)};n.utils.object.inherits(C,n.FieldTextInput),C.timeout=500,C.showPid_=0,C.openFieldFlydown_=null,C.DISPLAY_BELOW="BELOW",C.DISPLAY_RIGHT="RIGHT",C.DISPLAY_LOCATION=C.DISPLAY_BELOW,C.prototype.fieldCSSClassName="blocklyFieldFlydownField",C.prototype.flyoutCSSClassName="blocklyFieldFlydownFlydown",C.prototype.showEditor_=function(){this.EDITABLE&&(C.showPid_&&(clearTimeout(C.showPid_),C.showPid_=0,n.hideChaff()),C.superClass_.showEditor_.call(this))},C.prototype.init=function(t){C.superClass_.init.call(this,t),n.utils.dom.removeClass(this.fieldGroup_,"blocklyEditableText"),n.utils.dom.removeClass(this.fieldGroup_,"blocklyNoNEditableText"),n.utils.dom.addClass(this.fieldGroup_,this.fieldCSSClassName),this.mouseOverWrapper_=n.bindEvent_(this.fieldGroup_,"mouseover",this,this.onMouseOver_),this.mouseOutWrapper_=n.bindEvent_(this.fieldGroup_,"mouseout",this,this.onMouseOut_)},C.prototype.onMouseOver_=function(t){this.sourceBlock_.isInFlyout||0!=C.showPid_||(C.showPid_=window.setTimeout(this.showFlydownMaker_(),C.timeout)),t.stopPropagation()},C.prototype.onMouseOut_=function(t){window.clearTimeout(C.showPid_),C.showPid_=0,t.stopPropagation()},C.prototype.showFlydownMaker_=function(){var t=this;return function(){if(0!==C.showPid_&&!t.getSourceBlock().workspace.isDragging()&&!this.htmlInput_)try{t.showFlydown_()}catch(t){console.error("Failed to show flydown",t)}C.showPid_=0}},C.prototype.showFlydown_=function(){n.hideChaff();var t=n.getMainWorkspace().getFlydown();n.getMainWorkspace().getParentSvg().appendChild(t.svgGroup_);var e=t.targetWorkspace.scale;t.workspace_.setScale(e),t.setCSSClass(this.flyoutCSSClassName);var o=this.flydownBlocksXML_(),i=n.Xml.textToDom(o),s=c(i),r=n.getMainWorkspace().getSvgXY(this.borderRect_),a=this.borderRect_.getBBox();this.displayLocation===C.DISPLAY_BELOW?r.y+=a.height*e:r.x+=a.width*e,t.field_=this,t.showAt(s,r.x,r.y),C.openFieldFlydown_=this},C.hide=function(){window.clearTimeout(C.showPid_);var t=n.getMainWorkspace().getFlydown();t&&t.hide()},C.prototype.onHtmlInputChange_=function(t){var e=this.htmlInput_,o=e.value;if(o!==e.oldValue_){e.oldValue_=o;var i=!0;this.sourceBlock_&&(i=function(t,e){var o=t.doClassValidation_(e);if(null===o)return null;void 0!==o&&(e=o);var i=t.getValidator();if(i){var n=i.call(t,e);if(null===n)return null;void 0!==n&&(e=n)}return e}(this,e.value)),null===i?n.utils.dom.addClass(e,"blocklyInvalidInput"):(n.utils.dom.removeClass(e,"blocklyInvalidInput"),this.doValueUpdate_(i))}else n.utils.userAgent.WEBKIT&&this.sourceBlock_.render();this.textContent_.nodeValue=o,this.forceRerender(),this.resizeEditor_(),n.svgResize(this.sourceBlock_.workspace)},C.prototype.dispose=function(){C.openFieldFlydown_==this&&C.hide(),n.FieldTextInput.prototype.dispose.call(this)},C.fromJson=function(t){var e=n.utils.replaceMessageReferences(t.name);return new C(e,t.is_editable)},n.fieldRegistry.register("field_flydown",C);
/**
 * @license
 ...
 * @author fturbak@wellesley.edu (Lyn Turbak)
 */
var I=function t(e){t.superClass_.constructor.call(this,e),this.dragAngleRange_=360};n.utils.object.inherits(I,n.VerticalFlyout),I.prototype.previousCSSClassName_="",I.prototype.VERTICAL_SEPARATION_FACTOR=1,I.prototype.createDom=function(t){return this.previousCSSClassName_=t,this.svgGroup_=n.utils.dom.createSvgElement("g",{class:t},null),this.svgBackground_=n.utils.dom.createSvgElement("path",{},this.svgGroup_),this.svgGroup_.appendChild(this.workspace_.createDom()),this.svgGroup_},I.prototype.setCSSClass=function(t){t!==this.previousCSSClassName_&&(n.utils.dom.removeClass(this.svgGroup_,this.previousCSSClassName_),n.utils.dom.addClass(this.svgGroup_,t),this.previousCSSClassName_=t)},I.prototype.init=function(t){n.Flyout.prototype.init.call(this,t,!1),t.getComponentManager().addCapability(this.id,n.ComponentManager.Capability.AUTOHIDEABLE)},I.prototype.position=function(){},I.prototype.showAt=function(t,e,o){n.Events.disable();try{this.show(t)}finally{n.Events.enable()}var i=this.CORNER_RADIUS*this.workspace_.scale,s=this.width_-2*i,r=this.height_-2*i,a=["M 0,"+i];a.push("a",i,i,0,0,1,i,-i),a.push("h",s),a.push("a",i,i,0,0,1,i,i),a.push("v",r),a.push("a",i,i,0,0,1,-i,i),a.push("h",-s),a.push("a",i,i,0,0,1,-i,-i),a.push("z"),this.svgBackground_.setAttribute("d",a.join(" ")),this.svgGroup_.setAttribute("transform","translate("+e+", "+o+")")},I.prototype.reflow=function(){this.workspace_.scale=this.targetWorkspace.scale;for(var t,e=this.workspace_.scale,o=0,i=0,n=this.CORNER_RADIUS*e,s=this.workspace_.getTopBlocks(!1),r=0;t=s[r];r++){var a=t.getHeightWidth();o=Math.max(o,a.width*e),i+=a.height*e}o+=2*n+this.tabWidth_*e;var l=this.workspace_.getRenderer().getConstants(),c=l.ADD_START_HATS?l.START_HAT_HEIGHT:0;if(i+=3*n+n*this.VERTICAL_SEPARATION_FACTOR*s.length+c*e/2,this.width_!=o){for(var u,h=0;u=s[h];h++){var p=u.getHeightWidth(),_=u.getRelativeToSurfaceXY();if(this.RTL){var d=o-n-e*(this.tabWidth_-_.x);u.moveBy(d,0),_.x+=d}u.flyoutRect_&&(u.flyoutRect_.setAttribute("width",p.width),u.flyoutRect_.setAttribute("height",p.height),u.flyoutRect_.setAttribute("x",this.RTL?_.x-p.width:_.x),u.flyoutRect_.setAttribute("y",_.y))}this.width_=o,this.height_=i}},I.prototype.onMouseMove_=function(t){},I.prototype.placeNewBlock_=function(t){var e=this.targetWorkspace,o=t.getSvgRoot();if(!o)throw Error("originBlock is not rendered.");var i=this.workspace_.scale,s=this.workspace_.getSvgXY(o),r=s.x;s.x+=r/e.scale-r;var a=s.y;i=e.scale,s.y+=a/i-a;var l=n.Xml.blockToDom(t),c=n.Xml.domToBlock(l,e),u=c.getSvgRoot();if(!u)throw Error("block is not rendered.");var h=e.getSvgXY(u);return h.x+=e.scrollX/e.scale-e.scrollX,h.y+=e.scrollY/e.scale-e.scrollY,e.toolbox_&&!e.scrollbar&&(h.x+=e.toolbox_.getWidth()/e.scale,h.y+=e.toolbox_.getHeight()/e.scale),c.moveBy(s.x-h.x,s.y-h.y),c},I.prototype.shouldHide=!0,I.prototype.hide=function(){this.shouldHide&&(n.Flyout.prototype.hide.call(this),C.openFieldFlydown_=null),this.shouldHide=!0},I.prototype.autoHide=function(){this.hide()};
/**
 * @license
 ...
 * @author fturbak@wellesley.edu (Lyn Turbak)
 */
var k=function t(e,o){t.superClass_.constructor.call(this,e,!0,o,f.renameGlobal)};n.utils.object.inherits(k,C),k.prototype.fieldCSSClassName="blocklyFieldParameter",k.prototype.flyoutCSSClassName="blocklyFieldParameterFlydown",k.prototype.flydownBlocksXML_=function(){var t=n.Msg.LANG_VARIABLES_GLOBAL_PREFIX+" "+this.getText();return'<xml><block type="lexical_variable_get"><title name="VAR">'+t+'</title></block><block type="lexical_variable_set"><title name="VAR">'+t+"</title></block></xml>"},k.fromJson=function(t){var e=n.utils.replaceMessageReferences(t.name);return new k(e)},n.fieldRegistry.register("field_global_flydown",k);var O=function(){for(var t=arguments.length,e=new Array(t),o=0;o<t;o++)e[o]=arguments[o];n.FieldDropdown.apply(this,e)};n.utils.object.inherits(O,n.FieldDropdown),O.prototype.doClassValidation_=function(t){for(var e,o=!1,i=this.getOptions(!0),n=0;e=i[n];n++)if(e[1]===t){o=!0;break}return o||this.generatedOptions_.push([t,t]),t},O.fromJson=function(t){return new O(t.options,void 0,t)},n.fieldRegistry.register("field_nocheck_dropdown",O);
/**
 * @license
 ...
 * @author fturbak@wellesley.edu (Lyn Turbak)
 */
var A=function t(e,o,i,n){t.superClass_.constructor.call(this,e,o,i,(function(e){if(!t.changeHandlerEnabled)return e;var o=f.renameParam.call(this,e);return n&&n.call(this,o),o}))};n.utils.object.inherits(A,C),A.prototype.fieldCSSClassName="blocklyFieldParameter",A.prototype.flyoutCSSClassName="blocklyFieldParameterFlydown",A.changeHandlerEnabled=!0,A.withChangeHanderDisabled=function(t){var e=A.changeHandlerEnabled;A.changeHandlerEnabled=!1;try{t()}finally{A.changeHandlerEnabled=e}},A.prototype.flydownBlocksXML_=function(){var t=this.getText();return'<xml><block type="lexical_variable_get"><field name="VAR">'+t+'</field></block><block type="lexical_variable_set"><field name="VAR">'+t+"</field></block></xml>"},A.addHorizontalVerticalOption=function(t,e){var o=0;if(t.getParameters&&(o=t.getParameters().length),!(t.isCollapsed()||o<=0)){for(var i,s={enabled:!0,text:t.horizontalParameters?n.Msg.VERTICAL_PARAMETERS:n.Msg.HORIZONTAL_PARAMETERS,callback:function(){t.setParameterOrientation(!t.horizontalParameters)}},r=0;(i=e[r])&&i.text!=n.Msg.COLLAPSE_BLOCK;r++);e.splice(r,0,s);for(var a,l=0;a=e[l];l++)if(a.text==n.Msg.INLINE_INPUTS){e.splice(l,1);break}}},A.fromJson=function(t){var e=n.utils.replaceMessageReferences(t.name);return new A(e,t.is_editable)},n.fieldRegistry.register("field_parameter_flydown",A);
/**
 * @license
 ...
 */
var N=function t(e){t.superClass_.constructor.call(this,e,R)};function D(t){var e=d(t),o=e[0],i=e[1];return o===n.Msg.LANG_VARIABLES_GLOBAL_PREFIX||"global"===o?i:function(t){return""+t}(i)}function L(t,e){var o=n.JavaScript.valueToCode(t,"VALUE",n.JavaScript.ORDER_ASSIGNMENT)||"0";return D(t.getFieldValue(e))+" = "+o+";\n"}function M(t){var e=new I(new n.Options({scrollbars:!1}));t.flydown_=e,n.utils.dom.insertAfter(e.createDom("g"),t.svgBubbleCanvas_),e.init(t),e.autoClose=!0}n.utils.object.inherits(N,n.FieldTextInput),N.prototype.setValue=function(t){var e=this.getValue();if(this.oldName_=e,this.doValueUpdate_(t),N.superClass_.setValue.call(this,t),"string"==typeof(t=this.getValue())&&this.sourceBlock_){var o=this.sourceBlock_.workspace.getProcedureDatabase();o&&(o.getProcedure(this.sourceBlock_.id)?o.renameProcedure(this.sourceBlock_.id,e,t):o.addProcedure(t,this.sourceBlock_))}this.oldName_=void 0},N.fromJson=function(t){var e=n.utils.replaceMessageReferences(t.name);return new N(e)},n.fieldRegistry.register("field_procedurename",N),
/**
 * @license
 * @fileoverview Variables blocks for Blockly, modified for MIT App Inventor.
 * @author fturbak@wellesley.edu (Lyn Turbak)
 */
delete n.Blocks.global_declaration,n.Blocks.global_declaration={category:"Variables",helpUrl:n.Msg.LANG_VARIABLES_GLOBAL_DECLARATION_HELPURL,init:function(){this.setStyle("variable_blocks"),this.appendValueInput("VALUE").appendField(n.Msg.LANG_VARIABLES_GLOBAL_DECLARATION_TITLE_INIT).appendField(new k(n.Msg.LANG_VARIABLES_GLOBAL_DECLARATION_NAME,C.DISPLAY_BELOW),"NAME").appendField(n.Msg.LANG_VARIABLES_GLOBAL_DECLARATION_TO),this.setTooltip(n.Msg.LANG_VARIABLES_GLOBAL_DECLARATION_TOOLTIP)},getVars:function(){var t=this.getField("NAME");return t?[t.getText()]:[]},getGlobalNames:function(){return this.getVars()},renameVar:function(t,e){n.Names.equals(t,this.getFieldValue("NAME"))&&this.setFieldValue(e,"NAME")}},n.Blocks.lexical_variable_get={category:"Variables",helpUrl:n.Msg.LANG_VARIABLES_GET_HELPURL,init:function(){this.setStyle("variable_blocks"),this.fieldVar_=new E(" "),this.fieldVar_.setBlock(this),this.appendDummyInput().appendField(n.Msg.LANG_VARIABLES_GET_TITLE_GET).appendField(this.fieldVar_,"VAR"),this.setOutput(!0,null),this.setTooltip(n.Msg.LANG_VARIABLES_GET_TOOLTIP),this.errors=[{func:h},{func:p,dropDowns:["VAR"]}],this.setOnChange((function(t){u(this)}))},referenceResults:function(t,e,o){for(var i=this.getChildren().map((function(i){return f.referenceResult(i,t,e,o)})),s=[],r=[],a=0;a<i.length;a++)s=s.concat(i[a][0]),r=r.concat(i[a][1]);var l=this.getField("VAR").getText(),c=d(l),u=c[0],h=c[1],p=-1==o.indexOf(h);u!==n.Msg.LANG_VARIABLES_GLOBAL_PREFIX&&(h===t&&p?(s.push(this),r=r.concat(o)):p&&r.push(h));return[[s,r]]},getVars:function(){return[this.getFieldValue("VAR")]},renameLexicalVar:function(t,e,o,i){void 0===o?t===this.getFieldValue("VAR")&&this.setFieldValue(e,"VAR"):o&&o===this.fieldVar_.getText()&&(this.fieldVar_.getOptions(!1),this.fieldVar_.setValue(e),t===e&&this.setFieldValue(e,"VAR"),this.fieldVar_.forceRerender())},renameFree:function(t){var e=n.unprefixName(this.getFieldValue("VAR"));if(e[0]!==n.Msg.LANG_VARIABLES_GLOBAL_PREFIX){var o=e[1],i=t.apply(o);i!==o&&this.renameLexicalVar(o,i)}},freeVariables:function(){var t=n.unprefixName(this.getFieldValue("VAR"));if(t[0]!==n.Msg.LANG_VARIABLES_GLOBAL_PREFIX){var e=t[1];return new n.NameSet([e])}return new n.NameSet}},n.Blocks.lexical_variable_set={category:"Variables",helpUrl:n.Msg.LANG_VARIABLES_SET_HELPURL,init:function(){this.setStyle("variable_blocks"),this.fieldVar_=new E(" "),this.fieldVar_.setBlock(this),this.appendValueInput("VALUE").appendField(n.Msg.LANG_VARIABLES_SET_TITLE_SET).appendField(this.fieldVar_,"VAR").appendField(n.Msg.LANG_VARIABLES_SET_TITLE_TO),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.Msg.LANG_VARIABLES_SET_TOOLTIP),this.errors=[{func:h},{func:p,dropDowns:["VAR"]}],this.setOnChange((function(t){u(this)}))},referenceResults:n.Blocks.lexical_variable_get.referenceResults,getVars:function(){return[this.getFieldValue("VAR")]},renameLexicalVar:n.Blocks.lexical_variable_get.renameLexicalVar,renameFree:function(t){var e=n.unprefixName(this.getFieldValue("VAR"));if(e[0]!==n.Msg.LANG_VARIABLES_GLOBAL_PREFIX){var o=e[1],i=t.apply(o);i!==o&&this.renameLexicalVar(o,i)}this.getChildren().map((function(e){f.renameFree(e,t)}))},freeVariables:function(){var t=this.getChildren().map((function(t){return f.freeVariables(t)})),e=n.NameSet.unionAll(t),o=n.unprefixName(this.getFieldValue("VAR"));if(o[0]!==n.Msg.LANG_VARIABLES_GLOBAL_PREFIX){var i=o[1];e.insert(i)}return e}},n.Blocks.local_declaration_statement={category:"Variables",helpUrl:n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_HELPURL,bodyInputName:"STACK",init:function(){this.initLocals(),this.appendStatementInput("STACK").appendField(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_IN_DO),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_TOOLTIP),this.lexicalVarPrefix="local"},referenceResults:function(t,e,o){for(var i=[],n=0;this.getInput("DECL"+n);n++){var s=this.getFieldValue("VAR"+n);0,i.push(s)}for(var r=o.concat(i),a=[],l=0;this.getInput("DECL"+l);l++){var c=this.getInputTargetBlock("DECL"+l);c&&a.push(c)}var u=a.map((function(i){return f.referenceResult(i,t,e,o)})),h=f.referenceResult(this.getInputTargetBlock("STACK"),t,e,r),p=f.referenceResult(f.getNextTargetBlock(this),t,e,o);return u.concat([h,p])},withLexicalVarsAndPrefix:function(t,e){if(this.getInputTargetBlock(this.bodyInputName)==t)for(var o=this.declaredNames(),i=0;i<o.length;i++)e(o[i],this.lexicalVarPrefix)},initLocals:function(){this.setStyle("variable_blocks"),this.localNames_=[n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_DEFAULT_NAME],this.appendValueInput("DECL0").appendField(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_TITLE_INIT).appendField(this.parameterFlydown(0),"VAR0").appendField(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_INPUT_TO).setAlign(n.ALIGN_RIGHT),this.setMutator(new n.Mutator(["local_mutatorarg"]))},onchange:function(){this.localNames_=this.declaredNames()},mutationToDom:function(){for(var t=document.createElement("mutation"),e=0;e<this.localNames_.length;e++){var o=document.createElement("localname");o.setAttribute("name",this.localNames_[e]),t.appendChild(o)}return t},domToMutation:function(t){var e=c(t);if(e.length>0){this.localNames_=[];for(var o,i=0;o=e[i];i++)"localname"==o.nodeName.toLowerCase()&&this.localNames_.push(o.getAttribute("name"))}this.updateDeclarationInputs_(this.localNames_)},updateDeclarationInputs_:function(t,e){var o=this.inputList[this.inputList.length-1],i=this.inputList.length-1,s=this.rendered;this.rendered=!1;var r=this;A.withChangeHanderDisabled((function(){for(var t=0;t<i;t++)r.removeInput("DECL"+t)})),this.inputList=[],this.localNames_=t;for(var a=0;a<t.length;a++){var l=this.appendValueInput("DECL"+a);l.appendField(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_TITLE_INIT).appendField(this.parameterFlydown(a),"VAR"+a).appendField(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_INPUT_TO).setAlign(n.ALIGN_RIGHT),e&&e[a]&&l.connection.connect(e[a])}this.inputList=this.inputList.concat(o),this.rendered=s,this.rendered&&(this.initSvg(),this.render())},parameterFlydown:function(t){var e=this.localNames_[t],o=this;return new A(e,!0,C.DISPLAY_RIGHT,(function(e){if(o.localNames_[t]=e,o.mutator&&o.mutator.rootBlock_){for(var i=0,s=o.mutator.rootBlock_.getInputTargetBlock("STACK");s&&i<t;)s=s.nextConnection&&s.nextConnection.targetBlock(),i++;s&&i==t&&n.Field.prototype.setValue.call(s.getField("NAME"),e)}}))},decompose:function(t){var e=t.newBlock("local_mutatorcontainer");e.initSvg(),e.setDefBlock(this);for(var o=e.getInput("STACK").connection,i=0;i<this.localNames_.length;i++){var n=this.getFieldValue("VAR"+i),s=t.newBlock("local_mutatorarg");s.initSvg(),s.setFieldValue(n,"NAME"),s.oldLocation=i,o.connect(s.previousConnection),o=s.nextConnection}return e},compose:function(t){for(var e=[],o=[],i=t.getInputTargetBlock("STACK");i;)e.push(i.getFieldValue("NAME")),o.push(i.valueConnection_),i=i.nextConnection&&i.nextConnection.targetBlock();f.stringListsEqual(this.localNames_,e)||this.updateDeclarationInputs_(e,o)},dispose:function(){for(var t=arguments.length,e=new Array(t),o=0;o<t;o++)e[o]=arguments[o];n.BlockSvg.prototype.dispose.apply(this,e)},saveConnections:function(t){for(var e=t.getInputTargetBlock("STACK"),o=0;e;){var i=this.getInput("DECL"+o);e.valueConnection_=i&&i.connection.targetConnection,o++,e=e.nextConnection&&e.nextConnection.targetBlock()}var n=this.getInput(this.bodyInputName);n&&(t.bodyConnection_=n.connection.targetConnection)},getVars:function(){for(var t,e=[],o=0;t=this.getField("VAR"+o);o++)e.push(t.getValue());return e},declaredNames:function(){return this.getVars()},declaredVariables:function(){return this.getVars()},initializerConnections:function(){for(var t,e=[],o=0;t=this.getInput("DECL"+o);o++)e.push(t.connection&&t.connection.targetConnection);return e},blocksInScope:function(){var t=this.getInputTargetBlock(this.bodyInputName);return t&&[t]||[]},renameVar:function(t,e){this.renameVars(n.Substitution.simpleSubstitution(t,e))},renameVars:function(t){var e=this.declaredNames(),o=t.map(e);if(!f.stringListsEqual(o,e)){var i=this.initializerConnections();if(this.updateDeclarationInputs_(o,i),this.mutator.isVisible())for(var n,s=this.mutator.workspace_.getAllBlocks(),r=0;n=s[r];r++)if("procedures_mutatorarg"==n.type){var a=n.getFieldValue("NAME"),l=t.apply(a);l!==a&&n.setFieldValue(l,"NAME")}}},renameBound:function(t,e){for(var o=n.Xml.domToText(this.mutationToDom()),i=this.declaredNames(),s=0;s<i.length;s++)f.renameFree(this.getInputTargetBlock("DECL"+s),e);var r=t.restrictDomain(i);this.renameVars(r);var a=e.remove(i).extend(r);f.renameFree(this.getInputTargetBlock(this.bodyInputName),a);var l=n.Xml.domToText(this.mutationToDom());if(n.Events.isEnabled()&&n.Events.fire(new n.Events.Change(this,"mutation",null,o,l)),this.nextConnection){var c=this.nextConnection.targetBlock();f.renameFree(c,e)}},renameFree:function(t){var e=this.declaredNames(),o=new n.NameSet(e),i=f.freeVariables(this.getInputTargetBlock(this.bodyInputName));i.subtract(o);var s=i.renamed(t),r=s.intersection(o);if(r.isEmpty())this.renameBound(new n.Substitution,t);else{for(var a,l=o.union(s).toList(),c={},u=r.toList(),h=0;a=u[h];h++){var p=E.nameNotIn(a,l);c[a]=p,l.push(p)}this.renameBound(new n.Substitution(c),t)}},freeVariables:function(){var t=f.freeVariables(this.getInputTargetBlock(this.bodyInputName)),e=this.declaredNames();t.subtract(new n.NameSet(e));for(var o=e.length,i=0;i<o;i++)t.union(f.freeVariables(this.getInputTargetBlock("DECL"+i)));if(this.nextConnection){var s=this.nextConnection.targetBlock();t.unite(f.freeVariables(s))}return t}},n.Blocks.local_declaration_expression={category:"Variables",helpUrl:n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_EXPRESSION_HELPURL,initLocals:n.Blocks.local_declaration_statement.initLocals,bodyInputName:"RETURN",init:function(){this.initLocals(),this.appendValueInput("RETURN").appendField(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_EXPRESSION_IN_RETURN),this.setOutput(!0,null),this.setTooltip(n.Msg.LANG_VARIABLES_LOCAL_DECLARATION_EXPRESSION_TOOLTIP)},referenceResults:function(t,e,o){for(var i=[],n=0;this.getInput("DECL"+n);n++){var s=this.getFieldValue("VAR"+n);0,i.push(s)}for(var r=o.concat(i),a=[],l=0;this.getInput("DECL"+l);l++){var c=this.getInputTargetBlock("DECL"+l);c&&a.push(c)}var u=a.map((function(i){return f.referenceResult(i,t,e,o)})),h=f.referenceResult(this.getInputTargetBlock("RETURN"),t,e,r);return u.concat([h])},withLexicalVarsAndPrefix:n.Blocks.local_declaration_statement.withLexicalVarsAndPrefix,onchange:n.Blocks.local_declaration_statement.onchange,mutationToDom:n.Blocks.local_declaration_statement.mutationToDom,domToMutation:n.Blocks.local_declaration_statement.domToMutation,updateDeclarationInputs_:n.Blocks.local_declaration_statement.updateDeclarationInputs_,parameterFlydown:n.Blocks.local_declaration_statement.parameterFlydown,blocksInScope:n.Blocks.local_declaration_statement.blocksInScope,decompose:n.Blocks.local_declaration_statement.decompose,compose:n.Blocks.local_declaration_statement.compose,dispose:n.Blocks.local_declaration_statement.dispose,saveConnections:n.Blocks.local_declaration_statement.saveConnections,getVars:n.Blocks.local_declaration_statement.getVars,declaredNames:n.Blocks.local_declaration_statement.declaredNames,declaredVariables:n.Blocks.local_declaration_statement.declaredVariables,renameVar:n.Blocks.local_declaration_statement.renameVar,renameVars:n.Blocks.local_declaration_statement.renameVars,renameBound:n.Blocks.local_declaration_statement.renameBound,renameFree:n.Blocks.local_declaration_statement.renameFree,freeVariables:n.Blocks.local_declaration_statement.freeVariables},n.Blocks.local_mutatorcontainer={init:function(){this.setStyle("variable_blocks"),this.appendDummyInput().appendField(n.Msg.LANG_VARIABLES_LOCAL_MUTATOR_CONTAINER_TITLE_LOCAL_NAMES),this.appendStatementInput("STACK"),this.setTooltip(n.Msg.LANG_VARIABLES_LOCAL_MUTATOR_CONTAINER_TOOLTIP),this.contextMenu=!1,this.mustNotRenameCapturables=!0},setDefBlock:function(t){this.defBlock_=t},getDefBlock:function(){return this.defBlock_},declaredNames:function(){for(var t=[],e=this.getInputTargetBlock("STACK");e;)t.push(e.getFieldValue("NAME")),e=e.nextConnection&&e.nextConnection.targetBlock();return t}},n.Blocks.local_mutatorarg={init:function(){this.setStyle("variable_blocks"),this.appendDummyInput().appendField(n.Msg.LANG_VARIABLES_LOCAL_MUTATOR_ARG_TITLE_NAME).appendField(new n.FieldTextInput(n.Msg.LANG_VARIABLES_LOCAL_MUTATOR_ARG_DEFAULT_VARIABLE,f.renameParam),"NAME"),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(""),this.contextMenu=!1,this.lexicalVarPrefix="local",this.mustNotRenameCapturables=!0},getContainerBlock:function(){for(var t=this.getParent();t&&"local_mutatorcontainer"!==t.type;)t=t.getParent();return this.cachedContainerBlock_=t&&"local_mutatorcontainer"===t.type&&t||null,this.cachedContainerBlock_},getDefBlock:function(){var t=this.getContainerBlock();return t&&t.getDefBlock()||null},blocksInScope:function(){var t=this.getDefBlock();return t&&t.blocksInScope()||[]},declaredNames:function(){var t=this.getContainerBlock();return t&&t.declaredNames()||[]},onchange:function(){var t=this.getFieldValue("NAME");if(t){var e=this.cachedContainerBlock_,o=this.getContainerBlock();if(!e&&o){var i=this.declaredNames(),n=i.indexOf(t);if(-1!=n)if(-1!=i.indexOf(t,n+1)){var s=E.nameNotIn(t,i);this.setFieldValue(s,"NAME")}}}}},n.Blocks.controls_forRange={category:"Control",helpUrl:n.Msg.LANG_CONTROLS_FORRANGE_HELPURL,init:function(){this.setStyle("loop_blocks"),this.appendValueInput("START").setCheck(l("number","input")).appendField(n.Msg.LANG_CONTROLS_FORRANGE_INPUT_ITEM).appendField(new A(n.Msg.LANG_CONTROLS_FORRANGE_INPUT_VAR,!0,C.DISPLAY_BELOW),"VAR").appendField(n.Msg.LANG_CONTROLS_FORRANGE_INPUT_START).setAlign(n.ALIGN_RIGHT),this.appendValueInput("END").setCheck(l("number","input")).appendField(n.Msg.LANG_CONTROLS_FORRANGE_INPUT_END).setAlign(n.ALIGN_RIGHT),this.appendValueInput("STEP").setCheck(l("number","input")).appendField(n.Msg.LANG_CONTROLS_FORRANGE_INPUT_STEP).setAlign(n.ALIGN_RIGHT),this.appendStatementInput("DO").appendField(n.Msg.LANG_CONTROLS_FORRANGE_INPUT_DO).setAlign(n.ALIGN_RIGHT),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.Msg.LANG_CONTROLS_FORRANGE_TOOLTIP),this.lexicalVarPrefix="counter"},referenceResults:function(t,e,o){var i=this.getFieldValue("VAR");var n=o.concat([i]);return[f.referenceResult(this.getInputTargetBlock("START"),t,e,o),f.referenceResult(this.getInputTargetBlock("END"),t,e,o),f.referenceResult(this.getInputTargetBlock("STEP"),t,e,o),f.referenceResult(this.getInputTargetBlock("DO"),t,e,n),f.referenceResult(f.getNextTargetBlock(this),t,e,o)]},withLexicalVarsAndPrefix:function(t,e){this.getInputTargetBlock("DO")==t&&e(this.getFieldValue("VAR"),this.lexicalVarPrefix)},getVars:function(){return[this.getFieldValue("VAR")]},blocksInScope:function(){var t=this.getInputTargetBlock("DO");return t?[t]:[]},declaredNames:function(){return[this.getFieldValue("VAR")]},renameVar:function(t,e){n.Names.equals(t,this.getFieldValue("VAR"))&&this.setFieldValue(e,"VAR")},renameBound:function(t,e){f.renameFree(this.getInputTargetBlock("START"),e),f.renameFree(this.getInputTargetBlock("END"),e),f.renameFree(this.getInputTargetBlock("STEP"),e);var o=this.getFieldValue("VAR"),i=t.apply(o);if(i!==o){this.renameVar(o,i);var s=n.Substitution.simpleSubstitution(o,i),r=e.extend(s);f.renameFree(this.getInputTargetBlock("DO"),r)}else{var a=e.remove([o]);f.renameFree(this.getInputTargetBlock("DO"),a)}if(this.nextConnection){var l=this.nextConnection.targetBlock();f.renameFree(l,e)}},renameFree:function(t){var e=this.getFieldValue("VAR"),o=f.freeVariables(this.getInputTargetBlock("DO"));o.deleteName(e);var i=o.renamed(t);if(i.isMember(e)){var s=E.nameNotIn(e,i.toList()),r=n.Substitution.simpleSubstitution(e,s);this.renameBound(r,t)}else this.renameBound(new n.Substitution,t)},freeVariables:function(){var t=f.freeVariables(this.getInputTargetBlock("DO"));if(t.deleteName(this.getFieldValue("VAR")),t.unite(f.freeVariables(this.getInputTargetBlock("START"))),t.unite(f.freeVariables(this.getInputTargetBlock("END"))),t.unite(f.freeVariables(this.getInputTargetBlock("STEP"))),this.nextConnection){var e=this.nextConnection.targetBlock();t.unite(f.freeVariables(e))}return t}},delete n.Blocks.controls_for,n.Blocks.controls_for=n.Blocks.controls_forRange,n.Blocks.controls_forEach={category:"Control",helpUrl:n.Msg.LANG_CONTROLS_FOREACH_HELPURL,init:function(){this.setStyle("loop_blocks"),this.appendValueInput("LIST").setCheck(l("list","input")).appendField(n.Msg.LANG_CONTROLS_FOREACH_INPUT_ITEM).appendField(new A(n.Msg.LANG_CONTROLS_FOREACH_INPUT_VAR,!0,C.DISPLAY_BELOW),"VAR").appendField(n.Msg.LANG_CONTROLS_FOREACH_INPUT_INLIST).setAlign(n.ALIGN_RIGHT),this.appendStatementInput("DO").appendField(n.Msg.LANG_CONTROLS_FOREACH_INPUT_DO),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.Msg.LANG_CONTROLS_FOREACH_TOOLTIP),this.lexicalVarPrefix="item"},referenceResults:function(t,e,o){var i=this.getFieldValue("VAR");var n=o.concat([i]);return[f.referenceResult(this.getInputTargetBlock("LIST"),t,e,o),f.referenceResult(this.getInputTargetBlock("DO"),t,e,n),f.referenceResult(f.getNextTargetBlock(this),t,e,o)]},withLexicalVarsAndPrefix:n.Blocks.controls_forRange.withLexicalVarsAndPrefix,getVars:function(){return[this.getFieldValue("VAR")]},blocksInScope:function(){var t=this.getInputTargetBlock("DO");return t?[t]:[]},declaredNames:function(){return[this.getFieldValue("VAR")]},renameVar:function(t,e){n.Names.equals(t,this.getFieldValue("VAR"))&&this.setFieldValue(e,"VAR")},renameBound:function(t,e){f.renameFree(this.getInputTargetBlock("LIST"),e);var o=this.getFieldValue("VAR"),i=t.apply(o);if(i!==o){this.renameVar(o,i);var s=n.Substitution.simpleSubstitution(o,i),r=e.extend(s);f.renameFree(this.getInputTargetBlock("DO"),r)}else{var a=e.remove([o]);f.renameFree(this.getInputTargetBlock("DO"),a)}if(this.nextConnection){var l=this.nextConnection.targetBlock();f.renameFree(l,e)}},renameFree:function(t){var e=this.getFieldValue("VAR"),o=f.freeVariables(this.getInputTargetBlock("DO"));o.deleteName(e);var i=o.renamed(t);if(i.isMember(e)){var s=E.nameNotIn(e,i.toList()),r=n.Substitution.simpleSubstitution(e,s);this.renameBound(r,t)}else this.renameBound(new n.Substitution,t)},freeVariables:function(){var t=f.freeVariables(this.getInputTargetBlock("DO"));if(t.deleteName(this.getFieldValue("VAR")),t.unite(f.freeVariables(this.getInputTargetBlock("LIST"))),this.nextConnection){var e=this.nextConnection.targetBlock();t.unite(f.freeVariables(e))}return t}},n.Blocks.controls_do_then_return={category:"Control",helpUrl:n.Msg.LANG_CONTROLS_DO_THEN_RETURN_HELPURL,init:function(){this.setStyle("loop_blocks"),this.appendStatementInput("STM").appendField(n.Msg.LANG_CONTROLS_DO_THEN_RETURN_INPUT_DO),this.appendValueInput("VALUE").appendField(n.Msg.LANG_CONTROLS_DO_THEN_RETURN_INPUT_RETURN).setAlign(n.ALIGN_RIGHT),this.setOutput(!0,null),this.setTooltip(n.Msg.LANG_CONTROLS_DO_THEN_RETURN_TOOLTIP)}},
/**
 * @license
 * @fileoverview Procedure blocks for Blockly, modified for MIT App Inventor.
 * @author mckinney@mit.edu (Andrew F. McKinney)
 */
n.Blocks.procedures_defnoreturn={category:"Procedures",helpUrl:n.Msg.LANG_PROCEDURES_DEFNORETURN_HELPURL,bodyInputName:"STACK",init:function(){this.setStyle("procedure_blocks");var t=n.Procedures.findLegalName(n.Msg.LANG_PROCEDURES_DEFNORETURN_PROCEDURE,this);this.createHeader(t),this.horizontalParameters=!0,this.appendStatementInput("STACK").appendField(n.Msg.LANG_PROCEDURES_DEFNORETURN_DO),this.setMutator(new n.Mutator(["procedures_mutatorarg"])),this.setTooltip(n.Msg.LANG_PROCEDURES_DEFNORETURN_TOOLTIP),this.arguments_=[],this.warnings=[{name:"checkEmptySockets",sockets:["STACK"]}],this.lexicalVarPrefix="input"},createHeader:function(t){return this.appendDummyInput("HEADER").appendField(n.Msg.LANG_PROCEDURES_DEFNORETURN_DEFINE).appendField(new N(t),"NAME")},withLexicalVarsAndPrefix:function(t,e){for(var o=this.declaredNames(),i=0;i<o.length;i++)e(o[i],this.lexicalVarPrefix)},onchange:function(){this.arguments_=this.declaredNames()},updateParams_:function(t){t&&(this.arguments_=t);for(var e=!1,o={},i=0;i<this.arguments_.length;i++){if(o["arg_"+this.arguments_[i].toLowerCase()]){e=!0;break}o["arg_"+this.arguments_[i].toLowerCase()]=!0}e?this.setWarningText(n.Msg.LANG_PROCEDURES_DEF_DUPLICATE_WARNING):this.setWarningText(null);var s=this.getFieldValue("NAME"),r=this.inputList[this.inputList.length-1],a=this.rendered;this.rendered=!1;var l=this;A.withChangeHanderDisabled((function(){l.removeInput("HEADER")}));var c=this.inputList.length-1;if(c>0&&this.getInput("VAR0"))for(var u=function(t){try{A.withChangeHanderDisabled((function(){l.removeInput("VAR"+t)}))}catch(t){console.log(t)}},h=0;h<c;h++)u(h);this.inputList=[];var p=this.createHeader(s);if(this.horizontalParameters)for(var _=0;_<this.arguments_.length;_++)p.appendField(" ").appendField(this.parameterFlydown(_),"VAR"+_);else for(var d=0;d<this.arguments_.length;d++)this.appendDummyInput("VAR"+d).appendField(this.parameterFlydown(d),"VAR"+d).setAlign(n.ALIGN_RIGHT);this.inputList=this.inputList.concat(r),this.rendered=a;for(var g=0;g<this.inputList.length;g++)this.inputList[g].init();this.rendered&&this.render(),this.workspace.loadCompleted&&n.Procedures.mutateCallers(this)},parameterFlydown:function(t){var e=this.arguments_[t],o=this;return new A(e,!0,this.horizontalParameters?C.DISPLAY_BELOW:C.DISPLAY_RIGHT,(function(e){if(o.arguments_[t]=e,n.Procedures.mutateCallers(o),o.mutator&&o.mutator.rootBlock_){for(var i=0,s=o.mutator.rootBlock_.getInputTargetBlock("STACK");s&&i<t;)s=s.nextConnection&&s.nextConnection.targetBlock(),i++;s&&i==t&&s.getField("NAME").setValue(e)}}))},setParameterOrientation:function(t){0!=this.getParameters().length&&t!==this.horizontalParameters&&(this.horizontalParameters=t,this.updateParams_(),n.Events.isEnabled()&&n.Events.fire(new n.Events.Ui(this,"parameter_orientation",(!this.horizontalParameters).toString(),this.horizontalParameters.toString())))},mutationToDom:function(){var t=document.createElement("mutation");this.horizontalParameters||t.setAttribute("vertical_parameters","true");for(var e=0;e<this.arguments_.length;e++){var o=document.createElement("arg");o.setAttribute("name",this.arguments_[e]),t.appendChild(o)}return t},domToMutation:function(t){for(var e,o=[],i=c(t),n=0;e=i[n];n++)"arg"==e.nodeName.toLowerCase()&&o.push(e.getAttribute("name"));this.horizontalParameters="true"!==t.getAttribute("vertical_parameters"),this.updateParams_(o)},decompose:function(t){var e=t.newBlock("procedures_mutatorcontainer");e.initSvg(),e.setProcBlock(this),this.paramIds_=[];for(var o=e.getInput("STACK").connection,i=0;i<this.arguments_.length;i++){var s=t.newBlock("procedures_mutatorarg");this.paramIds_.push(s.id),s.initSvg(),s.setFieldValue(this.arguments_[i],"NAME"),s.oldLocation=i,o.connect(s.previousConnection),o=s.nextConnection}return n.Procedures.mutateCallers(this),e},compose:function(t){var e=[];this.paramIds_=[];for(var o=t.getInputTargetBlock("STACK");o;)e.push(o.getFieldValue("NAME")),this.paramIds_.push(o.id),o=o.nextConnection&&o.nextConnection.targetBlock();f.stringListsEqual(e,this.arguments_)||(this.updateParams_(e),n.Procedures.mutateCallers(this))},dispose:function(){var t=this.getFieldValue("NAME"),e=this.editable_,o=this.workspace;e&&y(t,o);for(var i=arguments.length,s=new Array(i),r=0;r<i;r++)s[r]=arguments[r];n.BlockSvg.prototype.dispose.apply(this,s);var a=o.getProcedureDatabase();e&&a&&a.removeProcedure(this.id)},getProcedureDef:function(){return[this.getFieldValue("NAME"),this.arguments_,"RETURN"===this.bodyInputName]},getVars:function(){for(var t,e=[],o=0;t=this.getFieldValue("VAR"+o);o++)e.push(t);return e},declaredNames:function(){return this.getVars()},declaredVariables:function(){return this.getVars()},renameVar:function(t,e){this.renameVars(n.Substitution.simpleSubstitution(t,e))},renameVars:function(t){var e=this.getParameters(),o=t.map(e);if(!f.stringListsEqual(e,o)&&(this.updateParams_(o),this.mutator.isVisible()))for(var i,n=this.mutator.workspace_.getAllBlocks(),s=0;i=n[s];s++)if("procedures_mutatorarg"==i.type){var r=i.getFieldValue("NAME"),a=t.apply(r);a!==r&&i.setFieldValue(a,"NAME")}},renameBound:function(t,e){var o=t.restrictDomain(this.declaredNames());this.renameVars(o);var i=e.extend(o);f.renameFree(this.getInputTargetBlock(this.bodyInputName),i)},renameFree:function(t){this.freeVariables()},freeVariables:function(){var t=f.freeVariables(this.getInputTargetBlock(this.bodyInputName));if(t.subtract(new n.NameSet(this.declaredNames())),t.isEmpty())return t;throw Error("Violation of invariant: procedure declaration has nonempty free variables: "+t.toString())},blocksInScope:function(){var t=this.getInputTargetBlock(this.bodyInputName);return t&&[t]||[]},customContextMenu:function(t){A.addHorizontalVerticalOption(this,t)},getParameters:function(){return this.arguments_}},n.Blocks.procedures_defreturn={category:"Procedures",helpUrl:n.Msg.PROCEDURES_DEFRETURN_HELPURL,bodyInputName:"RETURN",init:function(){this.setStyle("procedure_blocks");var t=n.Procedures.findLegalName(n.Msg.LANG_PROCEDURES_DEFRETURN_PROCEDURE,this);this.createHeader(t),this.horizontalParameters=!0,this.appendValueInput("RETURN").setAlign(n.ALIGN_RIGHT).appendField(n.Msg.LANG_PROCEDURES_DEFRETURN_RETURN),this.setMutator(new n.Mutator(["procedures_mutatorarg"])),this.setTooltip(n.Msg.LANG_PROCEDURES_DEFRETURN_TOOLTIP),this.arguments_=[],this.warnings=[{name:"checkEmptySockets",sockets:["RETURN"]}]},createHeader:function(t){return this.appendDummyInput("HEADER").appendField(n.Msg.LANG_PROCEDURES_DEFRETURN_DEFINE).appendField(new N(t),"NAME")},withLexicalVarsAndPrefix:n.Blocks.procedures_defnoreturn.withLexicalVarsAndPrefix,onchange:n.Blocks.procedures_defnoreturn.onchange,updateParams_:n.Blocks.procedures_defnoreturn.updateParams_,parameterFlydown:n.Blocks.procedures_defnoreturn.parameterFlydown,setParameterOrientation:n.Blocks.procedures_defnoreturn.setParameterOrientation,mutationToDom:n.Blocks.procedures_defnoreturn.mutationToDom,domToMutation:n.Blocks.procedures_defnoreturn.domToMutation,decompose:n.Blocks.procedures_defnoreturn.decompose,compose:n.Blocks.procedures_defnoreturn.compose,dispose:n.Blocks.procedures_defnoreturn.dispose,getProcedureDef:n.Blocks.procedures_defnoreturn.getProcedureDef,getVars:n.Blocks.procedures_defnoreturn.getVars,declaredNames:n.Blocks.procedures_defnoreturn.declaredNames,declaredVariables:n.Blocks.procedures_defnoreturn.declaredVariables,renameVar:n.Blocks.procedures_defnoreturn.renameVar,renameVars:n.Blocks.procedures_defnoreturn.renameVars,renameBound:n.Blocks.procedures_defnoreturn.renameBound,renameFree:n.Blocks.procedures_defnoreturn.renameFree,freeVariables:n.Blocks.procedures_defnoreturn.freeVariables,blocksInScope:n.Blocks.procedures_defnoreturn.blocksInScope,customContextMenu:n.Blocks.procedures_defnoreturn.customContextMenu,getParameters:n.Blocks.procedures_defnoreturn.getParameters},n.Blocks.procedures_mutatorcontainer={init:function(){this.setStyle("procedure_blocks"),this.appendDummyInput().appendField(n.Msg.LANG_PROCEDURES_MUTATORCONTAINER_TITLE),this.appendStatementInput("STACK"),this.setTooltip(n.Msg.LANG_PROCEDURES_MUTATORCONTAINER_TOOLTIP),this.contextMenu=!1,this.mustNotRenameCapturables=!0},setProcBlock:function(t){this.procBlock_=t},getProcBlock:function(){return this.procBlock_},declaredNames:function(){for(var t=[],e=this.getInputTargetBlock("STACK");e;)t.push(e.getFieldValue("NAME")),e=e.nextConnection&&e.nextConnection.targetBlock();return t}},n.Blocks.procedures_mutatorarg={init:function(){this.setStyle("procedure_blocks");var t=new n.FieldTextInput("x",f.renameParam);t.onHtmlInputChange_=function(t){var e=this.getValue();C.prototype.onHtmlInputChange_.call(this,t);var o=this.getValue();o&&e!==o&&n.Events.isEnabled()&&n.Events.fire(new n.Events.Change(this.sourceBlock_,"field",this.name,e,o))},this.appendDummyInput().appendField(n.Msg.LANG_PROCEDURES_MUTATORARG_TITLE).appendField(t,"NAME"),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.Msg.LANG_PROCEDURES_MUTATORARG_TOOLTIP),this.contextMenu=!1,this.lexicalVarPrefix="input",this.mustNotRenameCapturables=!0},getContainerBlock:function(){for(var t=this.getParent();t&&"procedures_mutatorcontainer"!==t.type;)t=t.getParent();return this.cachedContainerBlock_=t&&"procedures_mutatorcontainer"===t.type&&t||null,this.cachedContainerBlock_},getProcBlock:function(){var t=this.getContainerBlock();return t&&t.getProcBlock()||null},declaredNames:function(){var t=this.getContainerBlock();return t&&t.declaredNames()||[]},blocksInScope:function(){var t=this.getProcBlock();return t&&t.blocksInScope()||[]},onchange:function(){var t=this.getFieldValue("NAME");if(t){var e=this.cachedContainerBlock_,o=this.getContainerBlock();if(!e&&o){var i=this.declaredNames(),n=i.indexOf(t);if(-1!=n)if(-1!=i.indexOf(t,n+1)){var s=E.nameNotIn(t,i);this.setFieldValue(s,"NAME")}}}}},n.Blocks.procedures_mutatorarg.validator=function(t){return(t=t.replace(/[\s\xa0]+/g," ").replace(/^ | $/g,""))||null},n.Blocks.procedures_callnoreturn={category:"Procedures",helpUrl:n.Msg.LANG_PROCEDURES_CALLNORETURN_HELPURL,init:function(){this.setStyle("procedure_blocks");var t=this.workspace.getTopWorkspace().getProcedureDatabase();this.procNamesFxn=function(){var e=t.getMenuItems(!1);return e.length>0?e:["",""]},this.procDropDown=new O(this.procNamesFxn,v),this.procDropDown.block=this,this.appendDummyInput().appendField(n.Msg.LANG_PROCEDURES_CALLNORETURN_CALL).appendField(this.procDropDown,"PROCNAME"),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.Msg.LANG_PROCEDURES_CALLNORETURN_TOOLTIP),this.arguments_=[],this.quarkConnections_=null,this.quarkArguments_=null,this.errors=[{func:h},{func:p,dropDowns:["PROCNAME"]}],this.setOnChange((function(t){u(this)})),v.call(this.getField("PROCNAME"),this.getField("PROCNAME").getValue())},getProcedureCall:function(){return this.getFieldValue("PROCNAME")},renameProcedure:function(t,e){t&&!n.Names.equals(t,this.getFieldValue("PROCNAME"))||(this.getField("PROCNAME").getOptions(),this.setFieldValue(e,"PROCNAME"))},setProcedureParameters:function(t,e,o){var i,s,r;if(e||(this.quarkConnections_={},this.quarkArguments_=null,e=[].concat(t)),e.length!=t.length)throw Error("Error: paramNames and paramIds must be the same length.");for(var a={},l=0;l<t.length;l++)a[e[l]]=t[l];void 0===o&&(o=null),this.quarkArguments_&&!o||(this.quarkConnections_={},f.stringListsEqual(t,this.arguments_)||o?this.quarkArguments_=e:this.quarkArguments_=[]);var c=this.rendered;for(this.rendered=!1,r=0;this.getInput("ARG"+r);r++)(i=this.getInput("ARG"+r))&&(s=i.connection.targetConnection,this.quarkConnections_[this.quarkArguments_[r]]=s,this.removeInput("ARG"+r));for(this.arguments_=[].concat(t),this.quarkArguments_=e,r=0;r<this.arguments_.length;r++)if(i=this.appendValueInput("ARG"+r).setAlign(n.ALIGN_RIGHT).appendField(this.arguments_[r]),this.quarkArguments_){var u=this.quarkArguments_[r];u in this.quarkConnections_?!(s=this.quarkConnections_[u])||s.targetConnection||s.sourceBlock_.workspace!=this.workspace?delete this.quarkConnections_[u]:i.connection.connect(s):a[u]&&(s=this.quarkConnections_[a[u]])&&i.connection.connect(s)}if(this.rendered=c,this.workspace.rendered){for(r=0;r<this.arguments_.length;r++)this.getInput("ARG"+r).init();this.rendered&&this.render()}},mutationToDom:function(){var t=document.createElement("mutation");t.setAttribute("name",this.getFieldValue("PROCNAME"));for(var e=0;this.getInput("ARG"+e);e++){var o=document.createElement("arg");o.setAttribute("name",this.getInput("ARG"+e).fieldRow[0].getText()),t.appendChild(o)}return t},domToMutation:function(t){var e=t.getAttribute("name");this.setFieldValue(e,"PROCNAME"),this.arguments_=[];for(var o,i=c(t),n=0;o=i[n];n++)"arg"==o.nodeName.toLowerCase()&&this.arguments_.push(o.getAttribute("name"));this.setProcedureParameters(this.arguments_,null,!0)},renameVar:function(t,e){for(var o=0;o<this.arguments_.length;o++)n.Names.equals(t,this.arguments_[o])&&(this.arguments_[o]=e,this.getInput("ARG"+o).fieldRow[0].setValue(e))},procCustomContextMenu:function(t){var e={enabled:!0};e.text=n.Msg.LANG_PROCEDURES_HIGHLIGHT_DEF;var o=this.getFieldValue("PROCNAME"),i=this.workspace;e.callback=function(){var t=n.Procedures.getDefinition(o,i);t&&(t.select(),i.centerOnBlock(t.id),i.getParentSvg().parentElement.focus())},t.push(e)},removeProcedureValue:function(){for(var t=0;null!==this.getInput("ARG"+t);t++)this.removeInput("ARG"+t);this.setFieldValue("none","PROCNAME")}},n.Blocks.procedures_callreturn={category:"Procedures",helpUrl:n.Msg.LANG_PROCEDURES_CALLRETURN_HELPURL,init:function(){this.setStyle("procedure_blocks");var t=this.workspace.getTopWorkspace().getProcedureDatabase();this.procNamesFxn=function(){var e=t.getMenuItems(!0);return e.length>0?e:["",""]},this.procDropDown=new O(this.procNamesFxn,v),this.procDropDown.block=this,this.appendDummyInput().appendField(n.Msg.LANG_PROCEDURES_CALLRETURN_CALL).appendField(this.procDropDown,"PROCNAME"),this.setOutput(!0,null),this.setTooltip(n.Msg.LANG_PROCEDURES_CALLRETURN_TOOLTIP),this.arguments_=[],this.quarkConnections_=null,this.quarkArguments_=null,this.errors=[{func:h},{func:p,dropDowns:["PROCNAME"]}],this.setOnChange((function(t){u(this)})),v.call(this.getField("PROCNAME"),this.getField("PROCNAME").getValue())},getProcedureCall:n.Blocks.procedures_callnoreturn.getProcedureCall,renameProcedure:n.Blocks.procedures_callnoreturn.renameProcedure,setProcedureParameters:n.Blocks.procedures_callnoreturn.setProcedureParameters,mutationToDom:n.Blocks.procedures_callnoreturn.mutationToDom,domToMutation:n.Blocks.procedures_callnoreturn.domToMutation,renameVar:n.Blocks.procedures_callnoreturn.renameVar,procCustomContextMenu:n.Blocks.procedures_callnoreturn.procCustomContextMenu,removeProcedureValue:n.Blocks.procedures_callnoreturn.removeProcedureValue},n.JavaScript.controls_for=function(t){var e,o=n.JavaScript.nameDB_.getName(t.getFieldValue("VAR"),n.VARIABLE_CATEGORY_NAME),i=n.JavaScript.valueToCode(t,"FROM",n.JavaScript.ORDER_ASSIGNMENT)||"0",s=n.JavaScript.valueToCode(t,"TO",n.JavaScript.ORDER_ASSIGNMENT)||"0",r=n.JavaScript.valueToCode(t,"BY",n.JavaScript.ORDER_ASSIGNMENT)||"1",a=n.JavaScript.statementToCode(t,"DO");if(a=n.JavaScript.addLoopTrap(a,t),n.isNumber(i)&&n.isNumber(s)&&n.isNumber(r)){var l=Number(i)<=Number(s);e="for (let "+o+" = "+i+"; "+o+(l?" <= ":" >= ")+s+"; "+o;var c=Math.abs(Number(r));e+=1==c?l?"++":"--":(l?" += ":" -= ")+c,e+=") {\n"+a+"}\n"}else{e="";var u=i;i.match(/^\w+$/)||n.isNumber(i)||(e+="let "+(u=n.JavaScript.nameDB_.getDistinctName(o+"_start",n.VARIABLE_CATEGORY_NAME))+" = "+i+";\n");var h=s;s.match(/^\w+$/)||n.isNumber(s)||(e+="let "+(h=n.JavaScript.nameDB_.getDistinctName(o+"_end",n.VARIABLE_CATEGORY_NAME))+" = "+s+";\n");var p=n.JavaScript.nameDB_.getDistinctName(o+"_inc",n.VARIABLE_CATEGORY_NAME);e+="let "+p+" = ",n.isNumber(r)?e+=Math.abs(r)+";\n":e+="Math.abs("+r+");\n",e+="if ("+u+" > "+h+") {\n",e+=n.JavaScript.INDENT+p+" = -"+p+";\n",e+="}\n",e+="for ("+o+" = "+u+"; "+p+" >= 0 ? "+o+" <= "+h+" : "+o+" >= "+h+"; "+o+" += "+p+") {\n"+a+"}\n"}return e},n.JavaScript.controls_forRange=n.JavaScript.controls_for,n.JavaScript.controls_forEach=function(t){var e=n.JavaScript.nameDB_.getName(t.getFieldValue("VAR"),n.VARIABLE_CATEGORY_NAME),o=n.JavaScript.valueToCode(t,"LIST",n.JavaScript.ORDER_ASSIGNMENT)||"[]",i=n.JavaScript.statementToCode(t,"DO");i=n.JavaScript.addLoopTrap(i,t);var s="",r=o;o.match(/^\w+$/)||(s+="const "+(r=n.JavaScript.nameDB_.getDistinctName(e+"_list",n.VARIABLE_CATEGORY_NAME))+" = "+o+";\n");var a=n.JavaScript.nameDB_.getDistinctName(e+"_index",n.VARIABLE_CATEGORY_NAME);return s+="for (let "+a+" in "+r+") {\n"+(i=n.JavaScript.INDENT+e+" = "+r+"["+a+"];\n"+i)+"}\n"},n.JavaScript.procedures_callreturn=function(t){for(var e=n.JavaScript.nameDB_.getName(t.getFieldValue("PROCNAME"),n.PROCEDURE_CATEGORY_NAME),o=[],i=t.getVars(),s=0;s<i.length;s++)o[s]=n.JavaScript.valueToCode(t,"ARG"+s,n.JavaScript.ORDER_NONE)||"null";return[e+"("+o.join(", ")+")",n.JavaScript.ORDER_FUNCTION_CALL]},n.JavaScript.lexical_variable_get=function(t){return[D(t.getFieldValue("VAR")),n.JavaScript.ORDER_ATOMIC]},n.JavaScript.lexical_variable_set=function(t){return L(t,"VAR")},n.JavaScript.global_declaration=function(t){return"var "+L(t,"NAME")},n.JavaScript.local_declaration_statement=function(){for(var t="{\n  let ",e=0;this.getFieldValue("VAR"+e);e++)t+=""+this.getFieldValue("VAR"+e),t+=" = "+(n.JavaScript.valueToCode(this,"DECL"+e,n.JavaScript.ORDER_NONE)||"0"),t+=", ";return t=t.slice(0,-2),t+=";\n",t+=n.JavaScript.statementToCode(this,"STACK",n.JavaScript.ORDER_NONE),t+="}\n"},n.JavaScript.local_declaration_expression=function(){return"NOT IMPLEMENTED YET"},n.Css.register(s)}])}));
